...
@section('content')
    ...
    <div class="sidenav">
      <img class="vertical v1" src="/storage/images/line1.png" alt="line" style="left: 6rem;" />
      <img class="vertical v2" src="/storage/images/line2.png" alt="line" style="left: 7.5rem;" />
      <img class="vertical v3" src="/storage/images/line3.png" alt="line" style="left: 9rem;" />
      <img class="vertical v4" src="/storage/images/line4.png" alt="line" style="left: 10.5rem;" />
      <img src="/storage/images/logo.png" alt="logo-o" />
  </div>
    <header>
      <img class="bar" src="/storage/images/bar.png" alt="bar">
      <h1>About Leo Club</h1>
    </header>
